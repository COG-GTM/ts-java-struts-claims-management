...
<ns:view path="/WEB-INF/jsp/admin/editAdjuster.jsp"/>
...
<td><html:text property="fullName"/></td></tr>
<tr><td><bean:message key="admin.region"/></td>
<td><html:text property="region"/></td></tr>
<tr><td><bean:message key="admin.active"/></td>
<td><html:text property="active"/></td></tr>
<tr><td>&nbsp;</td>
<td><html:submit><bean:message key="button.save"/></html:submit></td></tr>
</table>
</html:form>
<p><bean:message key="admin.edit.instruction"/></p>
